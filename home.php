...
<body>
    ...
    <nav class="navbar navbar-expand-lg" style="background-color:#0077b6;">
        <a class="navbar-brand ml-5" href="home.php" style="color:#fff;">Admin Dashboard</a>
        ...
        <div class="collapse navbar-collapse" id="navbarScroll">
            ...
            <li class="nav-item dropdown">
                <a href="display-marks.php" style="color:#fff; padding-right:25px;">Student Details</a>
                <a href="index.php" style="color:#fff; padding-right:15px;">Log Out</a>
            </li>
